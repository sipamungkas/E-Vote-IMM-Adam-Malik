...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Panel</b>Parti</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @endif">
          <a href="{{ url('admin/peserta') }}">
            <i class="fa fa-th"></i> <span>Peserta</span>
          </a>
        </li>
        <li class="
        @if($segment=='formatur')
        ...
        <li class="treeview">
           <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        <i class="fa fa-share"></i><span>{{ __('Logout') }}</span>
  ...
  <footer class="main-footer">
    ...
    reserved. E-Voting System by <a href="https://gitlab.com/raiglpamungkas">Ragil Burhanudin Pamungkas</a>
  </footer>
